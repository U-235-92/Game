...
public class CreatorRamEnemyType1 extends Ship
{
	...
	public CreatorRamEnemyType1(int x, int y, int speed) 
	{
	...
	public List<RamEnemyType1> createRamEnemyType1ForWall_Level_1()
	{
		List<RamEnemyType1> enemies = new LinkedList<RamEnemyType1>();
			...
			if(getGameFild().isPauseCreateEnemies() == false)
			{
				...
				if(flagForStartCreate == true)
				{
					if(flagForCreate == true)
					{
						...
						timeout = 600;
						RamEnemyType1 enemy = new RamEnemyType1(getX(), getY(), 50, 5, 0);
						...
						getGameFild().getRamEnemiesType1().addAll(enemies);
					}
				}
			}
		}
